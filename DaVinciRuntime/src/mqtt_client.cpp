    ...
    if (processor) {
        ...
        if (Json::parseFromStream(builder, ss, &json, &errs)) {
            ...
            if (processor->getType() == (int) SensorType::SHELLY_DIMMER) {
                ...
                db_->execute("INSERT INTO DimmerData (source, brightness, state, timestamp) VALUES ('" +
                            data.getSource() + "', " +
                ...
                db_->execute("INSERT INTO PlugData (source, power, timestamp) VALUES ('" +
                            data.getSource() + "', " +
                ...
                db_->execute("INSERT INTO TemperatureData (source, temperature, humidity, timestamp) VALUES ('" +
                            data.getSource() + "', " +
